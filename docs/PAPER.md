...
**Production runs (June 2026):** jobs `705eb2ff` (78 KU) + `26e288da` (422 other types), API `acme-api:longmemeval-transcript`, GPT-4.1, zero errors. Combined summary: `benchmark-results/longmemeval-v3-combined.json`.
