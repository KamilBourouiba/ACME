...
\textbf{Production runs (June 2026):} jobs \texttt{705eb2ff} +
\texttt{26e288da} (v3 transcript-first), then \texttt{c81eaa91} (v4 type
routing on 241 Q). Combined 500 Q summary:
\texttt{benchmark-results/longmemeval-v4-combined.json}.
...
oracle split (500 Q, GPT-4.1), per-type routed ACME reaches
\textbf{84.8\%} overall vs.~\textbf{78.0\%} (RAG), with the largest
