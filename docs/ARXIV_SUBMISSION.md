...
| **Comments** | 14-page preprint; MemoryBench v3 + LongMemEval oracle 84.8%; code at https://github.com/KamilBourouiba/ACME |
...
4. LongMemEval oracle **500 Q**: ACME **0.848** vs RAG **0.780** (v4 routing, June 2026); clean v5 hybrid run pending (`LONGMEMEVAL_TYPES=all`).
