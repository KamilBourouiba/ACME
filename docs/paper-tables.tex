...
\newcommand{\acmeTableLongMemEvalProtocol}{%
  \acmeTableBlockWide{LongMemEval oracle protocol (industry benchmark [37]).}{%
...
\newcommand{\acmeTableLongMemEvalFull}{%
  \acmeTableBlockWide{LongMemEval oracle full split (500 Q, GPT-4.1, June 2026).}{%
    ...
    \begin{tabular}{@{}l *{7}{S[table-format=1.3]}@{}}
      ...
      \midrule
      \rowcolor{acmerow}
      \textbf{ACME} & \textbf{0.848} & \textbf{0.944} & \textbf{0.793} & \textbf{0.709} & \textbf{1.000} & \textbf{1.000} & \textbf{0.933} \\
      MemGPT & 0.786 & 0.875 & 0.802 & 0.630 & 1.000 & 0.982 & 0.533 \\
      RAG & 0.780 & 0.889 & 0.793 & 0.622 & 1.000 & 0.964 & 0.433 \\
      \bottomrule
    \end{tabular}%
    }%
  }%
