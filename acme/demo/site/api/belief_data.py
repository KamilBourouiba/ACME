"""Canonical Belief Observatory trace — latency → churn investigation."""
...
TRACE_STEPS = [
    ...
    },
    {
        ...
        "activeEdges": [["e1", "h1"], ["e2", "h1"], ["h1", "b1"], ["h1", "c1"]],
        "clashEdges": [["h1", "c1"]],
        "inspector": {
            "id": "c1",
            "type": "Contradiction",
    ...
    },
    {
        ...
        "activeEdges": [["e1", "h1"], ["e2", "h1"], ["h1", "b2"], ["b1", "b2"]],
        "inspector": {
            "id": "b2",
            "type": "Belief",
